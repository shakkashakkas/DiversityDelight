...
public class ModCookingRecipes {
    ...
    private static void cookMisc(RecipeOutput output) {
        CookingPotRecipeBuilder.cookingPotRecipe(DDModItems.BANANA_MILK.get(), 1, FAST_COOKING, SMALL_EXP)
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(DDModItems.CHOCOLATE_ICE_CREAM.get(), 1, NORMAL_COOKING, SMALL_EXP)
                .addIngredient(Items.SNOWBALL)
                .addIngredient(DDModItems.ICE_CREAM_CONE.get())
                .addIngredient(CommonTags.FOODS_MILK)
                .addIngredient(Items.COCOA_BEANS)
                .addIngredient(Items.COCOA_BEANS)
                .unlockedByItems("has_ice_cream_cone", DDModItems.ICE_CREAM_CONE.get())
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .build(output);

        CookingPotRecipeBuilder.cookingPotRecipe(DDModItems.LEMON_ICE_CREAM.get(), 1, NORMAL_COOKING, SMALL_EXP)
                .addIngredient(Items.SNOWBALL)
                .addIngredient(DDModItems.ICE_CREAM_CONE.get())
                .addIngredient(CommonTags.FOODS_MILK)
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(DDModItems.PISTACHIO_ICE_CREAM.get(), 1, NORMAL_COOKING, SMALL_EXP)
                .addIngredient(Items.SNOWBALL)
                .addIngredient(DDModItems.ICE_CREAM_CONE.get())
                .addIngredient(CommonTags.FOODS_MILK)
    ...
    private static void cookMeals(RecipeOutput output) {
        CookingPotRecipeBuilder.cookingPotRecipe(DDModItems.BAKED_BEANS.get(), 1, NORMAL_COOKING, MEDIUM_EXP)
                ...
                .unlockedByAnyIngredient(DDModItems.SOY_BEANS)
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .build(output);

        CookingPotRecipeBuilder.cookingPotRecipe(DDModItems.BUFFALO_WINGS.get(), 1, SLOW_COOKING, MEDIUM_EXP)
                .addIngredient(ModItems.CHICKEN_CUTS.get())
                .addIngredient(ModItems.CHICKEN_CUTS.get())
                .addIngredient(DDModItems.CHILI.get())
                .addIngredient(DDModItems.CELERY.get())
                .addIngredient(DDModItems.CELERY.get())
                .addIngredient(DDModItems.PEA.get())
                .unlockedByAnyIngredient(Items.CHICKEN, DDModItems.CELERY, DDModItems.PEA)
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .build(output);

        CookingPotRecipeBuilder.cookingPotRecipe(DDModItems.CAULIFLOWER_SOUP.get(), 1, NORMAL_COOKING, MEDIUM_EXP)
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(DDModItems.CAULIFLOWER_STEAK.get(), 1, NORMAL_COOKING, SMALL_EXP)
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(DDModItems.GUMBO.get(), 1, SLOW_COOKING, MEDIUM_EXP)
                .addIngredient(DDCommonTags.CROPS_BELL_PEPPER)
                .addIngredient(DDCommonTags.CROPS_CELERY)
                .addIngredient(ModItems.BONE_BROTH.get())
                .addIngredient(CommonTags.FOODS_COOKED_COD)
                .addIngredient(CommonTags.FOODS_COOKED_SALMON)
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(DDModItems.MIXED_VEGETABLE_MEDLEY.get(), 1, NORMAL_COOKING, MEDIUM_EXP)
                ...
                .addIngredient(DDCommonTags.CROPS_PEA)
                .addIngredient(Items.CARROT)
                .addIngredient(DDModItems.GREEN_BEAN.get())
                .addIngredient(DDModItems.CORN.get())
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(DDModItems.PEANUT_NOODLES.get(), 1, NORMAL_COOKING, MEDIUM_EXP)
                .addIngredient(DDModItems.PEANUT.get())
                .addIngredient(DDModItems.PEANUT.get())
                .addIngredient(DDModItems.PEANUT.get())
                .addIngredient(CommonTags.FOODS_PASTA)
                .addIngredient(DDModItems.COOKED_TOFU.get())
                .addIngredient(DDModItems.COOKED_TOFU.get())
                .unlockedByItems("has_peanut", DDModItems.PEANUT)
                .setRecipeBookTab(CookingPotRecipeBookTab.MEALS)
                .build(output);
    }
}
