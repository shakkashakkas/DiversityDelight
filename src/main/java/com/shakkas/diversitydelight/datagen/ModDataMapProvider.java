...
public class ModDataMapProvider extends DataMapProvider {
    ...
    protected void gather(HolderLookup.Provider provider) {
        this.builder(NeoForgeDataMaps.COMPOSTABLES)
                .add(DDModItems.ALMOND.getId(), new Compostable(0.45f), false)
                ...
                .add(DDModItems.CORN.getId(), new Compostable(0.45f), false)
                .add(DDModItems.CORN_KERNELS.getId(), new Compostable(0.25f), false)
                ...
                .add(DDModItems.OATS.getId(), new Compostable(0.45f), false)
                .add(DDModItems.OAT_SEEDS.getId(), new Compostable(0.25f), false)
                ...
                .add(DDModItems.PEANUT.getId(), new Compostable(0.25f), false)
                .add(DDModItems.PEAR.getId(), new Compostable(0.45f), false)
                .add(DDModItems.PINEAPPLE.getId(), new Compostable(0.45f), false)
                .add(DDModItems.PISTACHIO.getId(), new Compostable(0.45f), false)
                .add(DDModItems.SOY.getId(), new Compostable(0.45f), false)
                .add(DDModItems.SOY_BEANS.getId(), new Compostable(0.25f), false)
                .add(DDModItems.WALNUT.getId(), new Compostable(0.45f), false);
    }
}
